...
function buildTable(payments){
    ...
    for(var key in payments) {
        ...
        tdPO.appendChild(document.createTextNode(formatNumberForTable(loan)));
...
function showTermDetails(paymentDetails, m, term){
    ...
    document.getElementById("principal-paid").innerHTML = checkDecimal(principalforterm) + "$";
    document.getElementById("interest-paid").innerHTML = checkDecimal(interestforterm) + "$";
    document.getElementById("total-paid").innerHTML = checkDecimal(total) + "$";
    document.getElementById("remaining-principal").innerHTML = checkDecimal(remaining) + "$";
}

function showDetailsRow(m, a, f, i, t){
    document.getElementById("details-amount").innerHTML = m + "$";
...
=======
>>>>>>> fef806d950e5a05f28b3a9712d7c4b96501aca27
